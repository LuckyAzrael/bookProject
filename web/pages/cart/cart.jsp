	...
	<div id="main">
		...
		<table>
			...
			<c:if test="${empty sessionScope.cart.items}">
				<tr>
					<td colspan="4">亲，当前购物车中没有商品</td>
					<td><a href="index.jsp">浏览商品</a></td>
				</tr>
			</c:if>
		...
		<div class="cart_info">
			...
			<span class="cart_span"><a class="clearCart" href="cartServlet?action=clean">清空购物车</a></span>
